...
--
-- Name: customers_id_seq; Type: SEQUENCE; Schema: public; Owner: kirill
--
...
ALTER TABLE public.customers_id_seq OWNER TO kirill;

--
-- Name: customers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: kirill
--

ALTER SEQUENCE public.customers_id_seq OWNED BY public.customers.customers_id;
...
CREATE TABLE public.purchase (
    ...
    CONSTRAINT purchase_status_check CHECK ((((status)::text = 'paid'::text) OR ((status)::text = 'in progress'::text) OR ((status)::text = 'delivered'::text)))
);
...
--
-- Name: customers customers_id; Type: DEFAULT; Schema: public; Owner: kirill
--

ALTER TABLE ONLY public.customers ALTER COLUMN customers_id SET DEFAULT nextval('public.customers_id_seq'::regclass);
...
COPY public.customers (customers_id, name, email, phone) FROM stdin;
...
--
-- Name: customers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: kirill
--
...
ALTER TABLE ONLY public.purchase
    ADD CONSTRAINT customer FOREIGN KEY (customer_id) REFERENCES public.customers(customers_id) ON UPDATE CASCADE NOT VALID;
